  ...
  columns = [
    {
      name: "Id",
      hiddenMobile: () => true,
      tableContent: serverConfig => <p>{serverConfig?.gameserver?.id}</p>,
    },
    {
      name: "Current Name",
      tableContent: serverConfig => <p>{serverConfig?.gameserver?.currentName}</p>,
      sortable: true
    },
    {
      name: "Current Match Config",
      tableContent: serverConfig => <p>{serverConfig?.currentMatchConfig?.configName}</p>,
    ...
    {
      name: "Game Password",
      tableContent: serverConfig => <p>{serverConfig.gamePassword}</p>,
    ...
    },
    {
      name: "Reserved Slots",
      hiddenMobile: () => true,
      tableContent: serverConfig => <p>{serverConfig.lastContact}</p>
    },
    {
      name: "Balance Clans",
      hiddenMobile: () => true,

...
export class To4stDetailEdit implements ComponentInterface {
   ...
   */
  async _saveEntity(entity: any, isEdit: boolean, afterEx: EventEmitter<string>) 
  {
    this.freeze = true;
    this.saveEntity.emit({entity: entity, transactionId: this.currentFormTransactionId, afterEx: afterEx});
  }
  ...
  export()
  {
    ...
    if(asStr)
    {
      this.downloadJSON(this.mapPreSerializeEntity?.(this.currentItemClone).fileName || this.name, asStr);
    }
  }
  ...
  {
    return this.currentItemClone ? JSON.stringify(this.mapPreSerializeEntity ? this.mapPreSerializeEntity(this.currentItemClone).mapped : this.currentItemClone, null, "\t") : "";
  }
  ...
  pasteFromString(data: string)
  {
    if(data && data.trim())
    {
      const parsed = JSON.parse(data, (key, value) => typeof value === "string" && iso8601.test(value) ? new Date(value) : value);
      const temp = {};
          ...
          props?.detailInput ? (
            <div class="field">
              ...
              <div class="field-body">
                <div class="control">
                <span class="has-tooltip-arrow has-tooltip-left" data-tooltip={props.tooltip ? props.tooltip(this.currentItem) : undefined}>
                  {props.detailInput(
  ...
  render() {
    ...
    const chunked = chunk(this.columns.filter(x => !!x.detailInput), this.columnsCount);
    if(chunked.length > 0)
    {
      ...
      if(diffFullLast > 0)
      {
        const empty = range(diffFullLast).map(() => ({} as ColumnDetailProps<any>));
          ...
          <div class="column has-margin-top-30">
              <article class="message">
                <div class="message-header">
                        <p>Details</p>
                        <div class={{"field has-addons": true, "is-hidden": !this.mapPreSerializeEntity}}>
                          <div class="control">
                            <button
                ...
                <div class="message-body">
                  ...
                  <div class="container has-margin-top-30">
                    <div class="level">
                          ...
                          <div class="field level-item">
                            <div class="control">
                              <button
                                ...
                                disabled={this.freeze || !this.currentItemClone}
                                onClick={() => this._saveEntity(this.currentItemClone, true, this.afterSave)}
                              >
                                Save
                              </button>
                            </div>
                          ...
                          <div class="field">
                            <div class="control">
                              <button
                                ...
                                disabled={isEqual(this.currentItem, this.currentItemClone)}
                                onClick={() => this.reset()}
                              >
                                Reset
                              </button>
                      ...
                      <div class={{"level-item": true, "is-hidden": !this.mapPreSerializeEntity}}>
                        <div class="field has-addons">
                          <div class="control">
                            <div class="file is-small">
                              <label class="file-label">
                                <input class="file-input is-small" disabled={this.freeze || !this.currentItemClone} type="file" name="resume" onChange={x => this.import((x.target as HTMLInputElement).files)} />
                                <span class="file-cta">

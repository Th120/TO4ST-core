...
authKeys?: [{	options:ValueTypes["AuthKeyQuery"]},ValueTypes["PaginatedAuthKey"]],
authKey?: [{	authKey:string},ValueTypes["AuthKey"]],
	authValid?:true,
registeredPlayers?: [{	options:ValueTypes["RegisteredPlayersQuery"]},ValueTypes["PaginatedRegisteredPlayers"]],
registeredPlayer?: [{	options:ValueTypes["RegisteredPlayerQuery"]},ValueTypes["RegisteredPlayer"]],
bans?: [{	options:ValueTypes["BanQuery"]},ValueTypes["PaginatedBan"]],
banCheck?: [{	banCheck:ValueTypes["BanCheck"]},ValueTypes["Ban"]],
gameservers?: [{	options:ValueTypes["GameserversQuery"]},ValueTypes["PaginatedGameserver"]],
gameserver?: [{	options:ValueTypes["GameserverQuery"]},ValueTypes["Gameserver"]],
matchConfigs?: [{	options:ValueTypes["MatchConfigsQuery"]},ValueTypes["PaginatedMatchConfig"]],
matchConfig?: [{	options:ValueTypes["MatchConfigQuery"]},ValueTypes["MatchConfig"]],
gameserverConfigs?: [{	options:ValueTypes["GameserverConfigsQuery"]},ValueTypes["PaginatedGameserverConfig"]],
gameserverConfig?: [{	gameserverId?:string | null},ValueTypes["GameserverConfig"]],
games?: [{	options:ValueTypes["GameQuery"]},ValueTypes["PaginatedGame"]],
game?: [{	gameId:string},ValueTypes["Game"]],
rounds?: [{	options:ValueTypes["RoundQuery"]},ValueTypes["PaginatedRound"]],
round?: [{	roundId:number},ValueTypes["Round"]],
	gameModes?:ValueTypes["PaginatedGameMode"],
playerRoundStats?: [{	options:ValueTypes["PlayerRoundStatsQuery"]},ValueTypes["PaginatedPlayerRoundStats"]],
playerRoundWeaponStats?: [{	options:ValueTypes["PlayerRoundWeaponStatsQuery"]},ValueTypes["PaginatedPlayerRoundWeaponStats"]],
playerStatistics?: [{	options:ValueTypes["PlayerStatisticsQuery"]},ValueTypes["PaginatedPlayerStatistics"]],
playerWeaponStatistics?: [{	options:ValueTypes["PlayerWeaponStatisticsQuery"]},ValueTypes["PlayerWeaponStatistics"]],
		__typename?: true
}>;
	["AuthKeyQuery"]: {
	page?:number | null,
	...
	["Mutation"]: AliasType<{
updateAppConfig?: [{	appConfig:ValueTypes["AppConfigInput"]},ValueTypes["AppConfig"]],
deleteAuthKey?: [{	authKey:string},true],
createUpdateAuthKey?: [{	authKey:ValueTypes["AuthKeyInput"]},ValueTypes["AuthKey"]],
...
createUpdateRegisteredPlayer?: [{	registeredPlayer:ValueTypes["RegisteredPlayerInput"]},ValueTypes["RegisteredPlayer"]],
...
createUpdateGameserver?: [{	gameserver:ValueTypes["GameserverInput"]},ValueTypes["Gameserver"]],
updateGameserver?: [{	gameserverUpdate:ValueTypes["GameserverUpdateInput"]},ValueTypes["Gameserver"]],
authPlayerToken?: [{	steamId64:string},true],
deleteMatchConfig?: [{	options:ValueTypes["MatchConfigQuery"]},true],
createUpdateMatchConfig?: [{	matchConfig:ValueTypes["MatchConfigInput"]},ValueTypes["MatchConfig"]],
deleteGameserverConfig?: [{	gameserverId:string},true],
createUpdateGameserverConfig?: [{	gameserverConfig:ValueTypes["GameserverConfigInput"]},ValueTypes["GameserverConfig"]],
assignMatchConfig?: [{	gameserverConfig:ValueTypes["GameserverConfigInput"]},ValueTypes["GameserverConfig"]],
deleteGames?: [{	gameInputs:ValueTypes["GameInput"][]},true],
createUpdateGame?: [{	gameInput:ValueTypes["GameInput"]},ValueTypes["Game"]],
deleteRounds?: [{	roundInputs:ValueTypes["RoundInput"][]},true],
createUpdateRound?: [{	roundInput:ValueTypes["RoundInput"]},ValueTypes["Round"]],
createUpdatePlayerRoundStats?: [{	playerRoundStatsInput:ValueTypes["PlayerRoundStatsInput"][]},true],
createUpdatePlayerRoundWeaponStats?: [{	playerRoundWeaponStatsInput:ValueTypes["PlayerRoundWeaponStatsInput"][]},true],
		__typename?: true
}>;
	["AppConfigInput"]: {

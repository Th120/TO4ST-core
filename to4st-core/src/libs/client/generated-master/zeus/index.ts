...
["DateTime"]:unknown;
	...
	["CommunityBackend"]: AliasType<{
	id?:true,
	masterserverKey?:true,
	description?:true,
	contact?:true,
	lastUrl?:true,
	enabledForStatisticsAggregation?:true,
	lastHeartbeat?:true,
	currentState?:true,
	lastUpdateAttempt?:true,
	aggregationRunningSince?:true,
		__typename?: true
}>;
	...
	communityBackend?:ValueTypes["CommunityBackend"],
	startedAt?:true,
	endedAt?:true,
	...
	["PaginatedCommunityBackend"]: AliasType<{
	content?:ValueTypes["CommunityBackend"],
	totalCount?:true,
	pageCount?:true,
		__typename?: true
}>;
...
authKey?: [{	authKey:string},ValueTypes["AuthKey"]],
	authValid?:true,
communityBackend?: [{	id:number},ValueTypes["CommunityBackend"]],
communityBackends?: [{	options:ValueTypes["CommunityBackendQuery"]},ValueTypes["PaginatedCommunityBackend"]],
...
round?: [{	roundId:string},ValueTypes["Round"]],
...
playerWeaponStatistics?: [{	options:ValueTypes["PlayerWeaponStatisticsQuery"]},ValueTypes["PlayerWeaponStatistics"]],
	...
	pageSize?:number | null,
	search?:string | null,
	maxAge?:ValueTypes["DateTime"] | null,
	orderDesc?:boolean | null
};
	["GameQuery"]: {
	page?:number | null,
...
createUpdateCommunityBackend?: [{	communityBackend:ValueTypes["CommunityBackendInput"]},ValueTypes["CommunityBackend"]],
deleteCommunityBackend?: [{	id:number},true],
heartBeat?: [{	address:string},true],
...
["DateTime"]:any;
	...
	lastHeartbeat?:ModelTypes["DateTime"],
	currentState?:ModelTypes["DateTime"],
	lastUpdateAttempt?:ModelTypes["DateTime"],
	aggregationRunningSince?:ModelTypes["DateTime"]
};
	["LoginResponse"]: {
	...
	communityBackend:ModelTypes["CommunityBackend"],
	...
	["PaginatedCommunityBackend"]: {
		content?:ModelTypes["CommunityBackend"][],
	totalCount:number,
	pageCount:number
};
	["PaginatedGame"]: {
	...
	authValid:boolean,
	communityBackend:ModelTypes["CommunityBackend"],
	communityBackends:ModelTypes["PaginatedCommunityBackend"],
	...
	["CommunityBackendQuery"]: GraphQLTypes["CommunityBackendQuery"];
	...
	createUpdateCommunityBackend:ModelTypes["CommunityBackend"],
	...
	["CommunityBackendInput"]: GraphQLTypes["CommunityBackendInput"];
...
["DateTime"]:any;
	...
	lastUrl?: string,
	enabledForStatisticsAggregation: boolean,
	lastHeartbeat?: GraphQLTypes["DateTime"],
	currentState?: GraphQLTypes["DateTime"],
	lastUpdateAttempt?: GraphQLTypes["DateTime"],
	aggregationRunningSince?: GraphQLTypes["DateTime"]
};
	["LoginResponse"]: {
	...
	communityBackend: GraphQLTypes["CommunityBackend"],
	...
	content?: Array<GraphQLTypes["CommunityBackend"]>,
	totalCount: number,
	pageCount: number
};
	["PaginatedGame"]: {
	...
	authValid: boolean,
	communityBackend: GraphQLTypes["CommunityBackend"],
	communityBackends: GraphQLTypes["PaginatedCommunityBackend"],
	...
	createUpdateCommunityBackend: GraphQLTypes["CommunityBackend"],
	deleteCommunityBackend: boolean,
	heartBeat: boolean,
	deleteGames: boolean,
	deleteRounds: boolean
...
export const Gql = Chain('http://localhost:3001/graphql')